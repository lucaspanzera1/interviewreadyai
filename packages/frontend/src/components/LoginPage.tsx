      ...
      <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white dark:bg-slate-950">
        ...
        <div className="flex flex-col justify-center items-center p-8 lg:p-16 bg-white dark:bg-slate-950 relative z-10 transition-colors duration-200">
          <div className="w-full max-w-[380px] space-y-8">
            {/* Back Link */}
            <Link to="/" className="inline-flex items-center text-sm text-slate-500 hover:text-slate-900 dark:hover:text-slate-200 transition-colors mb-2 group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1 group-hover:-translate-x-1 transition-transform">
            ...
            <div className="mt-8 space-y-6">
              <div className="space-y-1">
                <h2 className="text-base font-semibold text-slate-900 dark:text-white">{t('accessPlatform')}</h2>
                <p className="text-sm text-slate-500 dark:text-slate-400">{t('continueJourney')}</p>
              </div>
